...
if __name__ == "__main__":
    ...
    with open("./evaluatelog2.txt", mode='a') as f:
        for res in result:
        ...
        ax1.plot(entropy_data_smooth, color = 'red', linewidth = 1.00)
        ax1.fill_between(x_axis, entropy_data_smooth-error_entropy_data_smooth, entropy_data_smooth+error_entropy_data_smooth, facecolor='red', edgecolor='red', alpha=0.15)

        plt.savefig('./entropy.jpg', dpi=200)
